      ...
      <CardContent className=' py-[18px] px-4 '>
        <div className='flex gap-6'>
          <div className='flex-none'>
            <Chart options={options as ApexOptions} series={chartSeries} type={chartType} height={48} width={48} />
          </div>
          <div className='flex-1'>
            <div className='text-default-800  text-sm mb-1 font-medium'>{title}</div>
