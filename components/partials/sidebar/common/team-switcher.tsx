          ...
          >
            {config.collapsed && !hovered ? (
              <Button
                ...
                className={cn('  h-14 w-14 mx-auto  p-0 md:p-0  dark:border-secondary ring-offset-sidebar')}
              >
                <Avatar className=''>
                  <AvatarImage
                    height={24}
              ...
              <Button
                ...
                aria-expanded={open}
                aria-label='Select a team'
                className={cn('  h-auto py-3 md:px-3 px-3 justify-start dark:border-secondary ring-offset-sidebar')}
              >
