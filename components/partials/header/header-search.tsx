          ...
          <CommandList className='py-5 px-3 max-h-[500px]'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
              ...
              >
                ...
                <CommandItem className='aria-selected:bg-transparent p-0 mb-2.5'>
                  <Link href='/ecommerce' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
                    <Icon icon='heroicons:shopping-bag' />
                    <span>eCommerce</span>
                  </Link>
                </CommandItem>
                <CommandItem className='aria-selected:bg-transparent p-0 '>
                  <Link href='/project' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
              ...
              >
                <CommandItem className='aria-selected:bg-transparent p-0 mb-2.5'>
                  <Link href='/chat' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
                    <Icon icon='heroicons:chat-bubble-bottom-center' />
                    <span>Chat</span>
                  </Link>
                </CommandItem>
                <CommandItem className='aria-selected:bg-transparent p-0 mb-2.5'>
                  <Link href='/email' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
              ...
              >
                <CommandItem className='aria-selected:bg-transparent p-0 mb-2.5'>
                  <Link href='/accordion' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
                    <Icon icon='heroicons:bars-3' />
                    <span>Accordion</span>
                  </Link>
                </CommandItem>
                <CommandItem className='aria-selected:bg-transparent p-0 mb-1'>
                  <Link href='/checkbox' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
                    <Icon icon='heroicons:check' />
                    <span>Checkboxes</span>
                  </Link>
                </CommandItem>
                <CommandItem className='aria-selected:bg-transparent p-0 mb-1'>
                  <Link href='/alert' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
                    <Icon icon='heroicons:megaphone' />
                    <span>Alert</span>
                  </Link>
                </CommandItem>
                <CommandItem className='aria-selected:bg-transparent p-0 mb-1'>
                  <Link href='/pagination' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
              ...
              >
                <CommandItem className='aria-selected:bg-transparent p-0 mb-2.5'>
                  <Link href='/simple-table' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
                    <Icon icon='heroicons:table-cells' />
                    <span>Simple Table</span>
                  </Link>
                </CommandItem>
                <CommandItem className='aria-selected:bg-transparent p-0 mb-2.5'>
                  <Link href='/tailwindui-table' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
                    <Icon icon='heroicons:table-cells' />
                    <span>Tailwind Ui Table</span>
                  </Link>
                </CommandItem>
                <CommandItem className='aria-selected:bg-transparent p-0 mb-2.5'>
                  <Link href='/data-table' className='flex gap-1 items-center px-2 text-default-500 hover:text-primary '>
                    <Icon icon='heroicons:table-cells' />
