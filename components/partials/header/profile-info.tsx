      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild className=' cursor-pointer'>
          <div className=' flex items-center gap-3  text-default-800 '>
            <Image src='/images/avatar/av-1.jpg' alt='D' width={36} height={36} className='rounded-full' />

            <div className='text-sm font-medium  capitalize lg:block hidden  '>Andres</div>
        ...
        <DropdownMenuContent className='w-56 p-0' align='end'>
          <DropdownMenuLabel className='flex gap-2 items-center mb-1 p-3'>
            <Image src='/images/avatar/av-1.jpg' alt='atomatic' width={36} height={36} className='rounded-full' />

            <div>
              <div className='text-sm font-medium text-default-800 capitalize '>Andres</div>
